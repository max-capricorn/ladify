  ...
  const option = {
    ...
    series: [
      ...
      },
      {
        ...
        stack: '信息',
        data: Array.from({ length: 6 }, () => Math.floor(Math.random() * 6)),
      },
    ],
  };
  return option;
    ...
    series: [
      {
        ...
        symbol: 'circle',
        data: [
          100, 120, 132, 101, 134, 90, 230, 210, 80, 20, 90, 210, 200, 100, 120,
          132, 101, 134, 90, 230, 210, 80, 20, 90,
        ],
      },
    ],
  };
...
export function getCustomChart() {}
